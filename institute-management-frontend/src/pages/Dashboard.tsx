...
const Dashboard: React.FC = () => {
  ...
  const teamMembers = [
    ...
    { name: 'Prof. James Wilson', email: 'james.wilson@institute.edu', role: 'Mathematics Department Head' },
    { name: 'Dr. Lisa Rodriguez', email: 'lisa.rodriguez@institute.edu', role: 'Research Coordinator' }
  ];
