  ...
  return (
    <div className="grid grid-cols-12 gap-y-10 gap-x-6">
      ...
      <div className="col-span-12">
        <div className="mb-6">
          <div className="flex flex-col md:h-10 gap-y-3 md:items-center md:flex-row">
            <div className="text-base font-medium dark:text-white group-[.mode--light]:text-white">
        ...
        <div className="p-1.5 bg-white dark:bg-darkmode-600 rounded-[0.6rem] border border-slate-200 dark:border-darkmode-400 shadow-sm">
          <div className="flex flex-col xl:flex-row gap-2">
                ...
                <div
                  ...
                  className={`col-span-4 sm:col-span-2 xl:col-span-1 flex-1 p-5 border-0 relative rounded-[0.6rem] overflow-hidden ${
                    stat.gradient
                      ...
                      : 'bg-slate-50 dark:bg-darkmode-700/50 dark:bg-darkmode-400'
                  }`}
                >
                  ...
                  <div className="flex items-center mt-12">
                    <div className={`text-2xl font-medium ${
                      stat.gradient ? 'text-white' : 'text-slate-700 dark:text-slate-100'
                    }`}>
                      {stat.value}
                    </div>
                  ...
                  <div className={`mt-1 text-base ${
                    stat.gradient ? 'text-white/70' : 'text-slate-500 dark:text-slate-300'
                  }`}>
                    {stat.title}
                  </div>
            ...
            <button className="bg-slate-50 dark:bg-darkmode-700 xl:w-20 text-slate-400/80 flex flex-col justify-center items-center p-5 border border-slate-300/80 rounded-[0.6rem] hover:bg-slate-100 border-dashed group dark:bg-darkmode-400">
      ...
      <div className="flex flex-col col-span-12 xl:col-span-6 gap-y-10">
        ...
        <div>
          <div className="flex flex-col md:h-10 gap-y-3 md:items-center md:flex-row">
            <div className="text-base font-medium dark:text-white">Recent Activities</div>
          </div>
          <div className="p-5 mt-3.5 bg-white dark:bg-darkmode-600 rounded-[0.6rem] border border-slate-200 dark:border-darkmode-400 shadow-sm">
            <div className="flex flex-col items-center pb-5 mb-5 border-b border-dashed gap-y-2 sm:flex-row border-slate-300/70">
              ...
              <div className="text-center sm:text-left sm:ml-4">
                <div className="text-base font-medium dark:text-white">Dr. Robert Anderson</div>
                <div className="text-slate-500 dark:text-slate-300 mt-0.5">Principal</div>
              </div>
            ...
            <div className="flex flex-col text-center gap-y-3 sm:flex-row">
              <div className="flex-1 border-dashed sm:border-r last:border-0">
                <div className="text-slate-500 dark:text-slate-300">Students Enrolled</div>
                <div className="flex items-center justify-center mt-1">
                  <div className="text-base font-medium dark:text-white">2,176</div>
              ...
              <div className="flex-1 border-dashed sm:border-r last:border-0">
                <div className="text-slate-500 dark:text-slate-300">Courses Completed</div>
                <div className="flex items-center justify-center mt-1">
                  <div className="text-base font-medium dark:text-white">2,027</div>
                  <div className="flex items-center ml-2 -mr-1 text-xs text-green-600">
                    2%
                    <ChevronUp className="w-4 h-4 ml-px" />
                  </div>
              ...
              <div className="flex-1 border-dashed sm:border-r last:border-0">
                <div className="text-slate-500 dark:text-slate-300">Faculty Meetings</div>
                <div className="flex items-center justify-center mt-1">
                  <div className="text-base font-medium dark:text-white">342</div>
        ...
        <div>
          <div className="flex flex-col md:h-10 gap-y-3 md:items-center md:flex-row">
            <div className="text-base font-medium dark:text-white">Invite Team Member</div>
          </div>
          <div className="p-5 mt-3.5 bg-white dark:bg-darkmode-600 rounded-[0.6rem] border border-slate-200 dark:border-darkmode-400 shadow-sm">
                ...
                <div key={index} className="flex items-center gap-3.5">
                  ...
                  <div className="flex flex-col w-full sm:items-center gap-y-2.5 sm:flex-row">
                    <div>
                      ...
                      <div className="text-xs text-slate-500 dark:text-slate-300 mt-0.5">{member.email}</div>
                    </div>
                    <div className="relative sm:ml-auto">
                      <Settings className="absolute inset-y-0 w-3.5 h-3.5 my-auto ml-2.5 stroke-[1.2]" />
                      <select className="bg-slate-50 dark:bg-darkmode-700 sm:w-48 pl-8 pr-2.5 py-1.5 text-xs border border-slate-200 rounded">
            ...
            <div>
              ...
              <div className="flex gap-3 mt-3">
                <input
                  ...
                  disabled
                  className="flex-1 px-3 py-2 text-slate-500 dark:text-slate-300 border border-slate-200 rounded bg-slate-50 dark:bg-darkmode-700"
                />
                <button
                  title="Copy link"
                  className="px-3 py-2 border border-slate-300 rounded hover:bg-slate-50 dark:bg-darkmode-700"
                >
      ...
      <div className="flex flex-col col-span-12 xl:col-span-6 gap-y-10">
        <div>
          <div className="flex flex-col md:h-10 gap-y-3 md:items-center md:flex-row">
            <div className="text-base font-medium dark:text-white">Academic Progress</div>
          </div>
          <div className="p-5 mt-3.5 bg-white dark:bg-darkmode-600 rounded-[0.6rem] border border-slate-200 dark:border-darkmode-400 shadow-sm">
            <div className="pb-5 mb-5 border-b border-dashed border-slate-300/70">
              ...
              <div className="flex flex-col gap-4 mt-5">
                <div className="flex flex-col items-center sm:flex-row gap-y-2">
                  <div className="sm:w-36 text-slate-500 dark:text-slate-300">Academic Year</div>
                  <div className="flex items-center font-medium sm:ml-5 sm:h-7">
                    2024-2025 Fall Semester
                  </div>
                </div>
                <div className="flex flex-col items-center sm:flex-row gap-y-2">
                  <div className="sm:w-36 text-slate-500 dark:text-slate-300">Total Students</div>
                ...
                <div className="flex flex-col items-center sm:flex-row gap-y-2">
                  <div className="sm:w-36 text-slate-500 dark:text-slate-300">Total Faculty</div>
            ...
            <div>
              <div className="flex items-center w-full px-3 py-3 font-medium border rounded-lg bg-slate-50 dark:bg-darkmode-700 text-slate-500 dark:text-slate-300 dark:bg-darkmode-400">
                ...
                {projectDetails.map((project, index) => (
                  ...
                  >
                    ...
                    <div className="-mt-1">
                      ...
                      <div className="flex items-center mt-2.5 text-xs text-slate-500 dark:text-slate-300">
